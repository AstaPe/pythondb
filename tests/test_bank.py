...
class TestBankSystem(unittest.TestCase):
    ...
    def test_bank_account_deposit(self):
        ...
        self.assertEqual(self.account.deposit(50, self.db), "Deposited 50. New balance: 150.0")

    def test_bank_account_withdraw(self):
        """Tests withdraw function in BankAccount"""
        self.assertEqual(self.account.withdraw(30, self.db), "Withdrew 30. New balance: 70.0")
